...
const translations = {
  en: {
    ...
    exec_secgen_role: 'General Secretary',
    ...
    exec2_name: 'Mahmuda Sultana Asma',
    exec2_aff1_title: 'Chairman and Managing Director', exec2_aff1_org: 'Bangladesh Nobojatok Hospital',
    exec3_name: 'Saykha Shuhada',
    exec3_aff1_title: 'Director', exec3_aff1_org: 'Bangladesh Nobojatok Hospital',
    exec4_name: 'Prof. Dr. Soofia Khatoon',
    exec4_aff1_title: 'Professor of Paediatrics (Ret.)', exec4_aff1_title2: 'Academic Director &amp; Head of Department (Paediatrics)', exec4_aff1_org: 'Ashulia Women &amp; Children Hospital, Dhaka',
    exec5_name: 'Md. Humayun Kabir Monju',
    exec5_aff1_title: 'Deputy Attorney General', exec5_aff1_org: 'Bangladesh Supreme Court',
    exec6_name: 'Amena Khatun',
    exec6_aff1_title: 'Joint Director (Ret.)', exec6_aff1_title2: 'Internal Audit', exec6_aff1_org: 'Bangladesh Bank',
    exec7_name: 'Abul Kashem',
    exec7_aff1_title: 'Joint Director (Ret.)', exec7_aff1_title2: 'Bank Inception Department', exec7_aff1_org: 'Bangladesh Bank',
    ...
    story06_text: "Mugdho was rescued after being abandoned in December 2024, then treated at Bangladesh Nobojatok Hospital. He spent 3 months on life support in the NICU battling ROP, hypothyroidism and a complex lung condition — an 11-month journey that ended with him fully recovered and placed with a loving family.",
    ...
    story12_text: 'On 21 October 2025, an abandoned baby girl was rescued late at night in Narsingdi and admitted to the NICU at Bangladesh Nobojatok Hospital. Named Minha, she recovered fully after nearly three months of care under Professor Dr. Md. Mozibur Rahman, and has since been placed with a loving family.',
    story13_date: '5 November 2025', story13_name: 'Unnamed baby girl', story13_outcome: 'Passed away',
    story13_text: 'A couple admitted a newborn daughter to Bangladesh Nobojatok Hospital at 3:30am on 5 November 2025, then left and could not be reached again. The foundation took full responsibility for her care, but she sadly passed away during treatment and was buried according to Islamic rites.',
    ...
    story21_text: "Taiyeba was found abandoned and helpless in Bamna upazila, Barguna, and first sheltered at the Chotomoni Nibash in Amtali. Prime Minister Tarek Rahman's office arranged for her transfer into the foundation's care at Bangladesh Nobojatok Hospital, where she now waits, hopeful, for a new life.",
  ...
  bn: {
    ...
    exec_secgen_role: 'জেনারেল সেক্রেটারি',
    ...
    exec2_name: 'মাহমুদা সুলতানা আসমা',
    exec2_aff1_title: 'চেয়ারম্যান ও ব্যবস্থাপনা পরিচালক', exec2_aff1_org: 'বাংলাদেশ নবজাতক হাসপাতাল',
    exec3_name: 'সাইখা শুহাদা',
    exec3_aff1_title: 'পরিচালক', exec3_aff1_org: 'বাংলাদেশ নবজাতক হাসপাতাল',
    exec4_name: 'অধ্যাপক ডা. সুফিয়া খাতুন',
    exec4_aff1_title: 'অধ্যাপক, শিশুরোগ বিভাগ (অবসরপ্রাপ্ত)', exec4_aff1_title2: 'একাডেমিক ডিরেক্টর ও বিভাগীয় প্রধান (শিশুরোগ বিভাগ)', exec4_aff1_org: 'আশুলিয়া উইমেন অ্যান্ড চিলড্রেন হসপিটাল, ঢাকা',
    exec5_name: 'মো. হুমায়ুন কবির মনজু',
    exec5_aff1_title: 'ডেপুটি অ্যাটর্নি জেনারেল', exec5_aff1_org: 'বাংলাদেশ সুপ্রিম কোর্ট',
    exec6_name: 'আমেনা খাতুন',
    exec6_aff1_title: 'যুগ্ম পরিচালক (অবসরপ্রাপ্ত)', exec6_aff1_title2: 'অভ্যন্তরীণ নিরীক্ষা', exec6_aff1_org: 'বাংলাদেশ ব্যাংক',
    exec7_name: 'আবুল কাশেম',
    exec7_aff1_title: 'যুগ্ম পরিচালক (অবসরপ্রাপ্ত)', exec7_aff1_title2: 'ব্যাংক ইনসেপশন বিভাগ', exec7_aff1_org: 'বাংলাদেশ ব্যাংক',
