...
const translations = {
  en: {
    ...
    exec_chair_role: 'Chairman',
    exec_secgen_role: 'Secretary General',
    exec_treasurer_role: 'Treasurer',
    exec_member_role: 'Executive Member',
    exec1_name: 'Full name', exec1_title: 'Founder &amp; President',
    exec1_aff1_title: 'Professional title', exec1_aff1_org: 'Organization name',
    exec1_aff2_title: 'Professional title', exec1_aff2_org: 'Organization name',
    exec1_aff3_title: 'Professional title', exec1_aff3_org: 'Organization name',
  ...
  bn: {
    ...
    exec_chair_role: 'চেয়ারম্যান',
    exec_secgen_role: 'মহাসচিব',
    exec_treasurer_role: 'কোষাধ্যক্ষ',
    exec_member_role: 'কার্যনির্বাহী সদস্য',
    exec1_name: 'পূর্ণ নাম', exec1_title: 'প্রতিষ্ঠাতা ও সভাপতি',
    exec1_aff1_title: 'পেশাগত পদবি', exec1_aff1_org: 'প্রতিষ্ঠানের নাম',
    exec1_aff2_title: 'পেশাগত পদবি', exec1_aff2_org: 'প্রতিষ্ঠানের নাম',
    exec1_aff3_title: 'পেশাগত পদবি', exec1_aff3_org: 'প্রতিষ্ঠানের নাম',
